...
class cmd_advpack_local_inf(PayloadType):
    name = "cmd_advpack_local_inf"
    file_extension = "cmd"
    author = "@hegusung"
    supported_os = [SupportedOS.Windows]
    wrapper = True
    note = """Executes advpack.exe to a INF file"""
    ...
    async def build(self) -> BuildResponse:
        ...
        try:
            ...
            payload = "%s advpack.dll,LaunchINFSection %s,%s" % (binary, inf_path, main_section)
